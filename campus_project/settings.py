...
# --------------------------------------------------
# Database Configuration (Auto-detects Postgres/MySQL)
# --------------------------------------------------
DATABASE_URL = os.environ.get('DATABASE_URL')

if DATABASE_URL:
    # Use the provided database (Postgres or MySQL)
    DATABASES = {
    ...
    # Fallback to local SQLite ONLY for building/development if no DB is linked
    DATABASES = {
        'default': {
